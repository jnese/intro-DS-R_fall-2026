...
The [Data Services Help Desk]( https://library.uoregon.edu/data-services) is open from 11:00am – 4:00pm M-F in Knight Library, past the DREAM Lab and on the right, near Room 135. The Help Desk also offers consultations [by appointment](https://uoregon.libcal.com/appointments/data_services) for statistics, `R`, `Python`/`JupyterLab`, `GIS`, data visualization, `GitHub`, Talapas, Excel, Qualtrics, and data analysis.

Their free [workshops](https://uoregon.libcal.com/calendar/dataservices?cid=11979&t=d&d=0000-00-00&cal=11979&inc=0) include classes on [`R`]( https://uoregon.libcal.com/calendar/dataservices?t=d&q=intro%20to%20r&cid=11979&cal=11979&ct=71948&inc=0), [`Python`]( https://uoregon.libcal.com/calendar/dataservices?t=d&q=python&cid=11979&cal=11979&ct=71947&inc=0), [`SQL`]( https://uoregon.libcal.com/calendar/dataservices?cid=11979&t=d&d=0000-00-00&cal=11979&ct=49049&inc=0), [Adobe Illustrator]( https://uoregon.libcal.com/calendar/dataservices?t=d&q=adobe%20illustrator&cid=11979&cal=11979&inc=0) and more! Students can craft and connect over snacks at [Arts and Crafts of Mapmaking](https://uoregon.libcal.com/calendar/dataservices?t=d&q=arts%20and%20crafts&cid=11979&cal=11979&inc=0) events. This term, their popular [Data and Society Book Club](https://uoregon.libcal.com/calendar/dataservices?cid=11979&t=d&d=0000-00-00&cal=11979&ct=83313&inc=0) is tackling Jerry Z. Muller’s *The Tyranny of Metrics*.
...
Students can use GenAI tools in this class to help with course work and assignments, but any use must be disclosed. Along with documentation of your GenAI use, you are also required to cite GenAI if you use any GenAI-created content in your work submissions, for example text or images or graphics generated by GenAI tools. That is, you need to treat GenAI just like other sources such as books, articles, videos, etc. You need to document your use, including:

1) The tool and version you used
2) What you used it for
3) How you reviewed, verified, or changed the output
4) A shared link to the full conversation

For example: *"AI use: I used Claude (Opus 5.5) to generate this part of my code, which I then revised with the if_else() function before submitting. Chat link: [URL]"* 

To create a shared link, use the "Share" button in your AI tool and paste the link into your disclosure. Instructions for some tools: [Claude](https://support.claude.com/en/articles/10593882-sharing-and-unsharing-chats), [ChatGPT](https://help.openai.com/en/articles/7925741-chatgpt-shared-links-faq), [Gemini](https://support.google.com/gemini/answer/13743730), [Copilot](https://support.microsoft.com/en-us/microsoft-copilot/conversation-history-in-microsoft-copilot). Create the link *after* you finish the conversation, since most tools share a snapshot and won't include later messages. Do not delete the conversation or the link before grades are returned. Some tools and school accounts don't allow sharing. If you can't create a link, submit the full conversation in one of these forms alongside your assignment: a PDF or printed export, screenshots of the complete conversation, or a copy-and-paste transcript that includes both your prompts and the AI's responses. Note in your disclosure why a link wasn't available. Note that shared links can be viewed by anyone who has them. Do not include personal information (yours or anyone else's) in conversations you plan to share.

In certain cases, as part of your documentation, I may ask you to submit any GenAI results you obtained, so you need to keep GenAI-created drafts and logs of your interactions with GenAI tools; failure to provide such documentation may result in a grade reduction in certain instances. Undisclosed use of AI may be treated as a violation of the course's academic integrity policy.

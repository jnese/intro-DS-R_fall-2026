...
execute: 
  ...
  warning: false
resources:
  - ../nopublish/popcorn/popcorn-experiment.html
---
...
## How many popcorn kernels in the jar? {.center background-color="#CC79A7"}
...
<iframe src="../nopublish/popcorn/popcorn-experiment.html" width="100%" height="600" style="border:none;"></iframe>
...
::: {.column width="50%"}
[**For this class**](https://jnese.github.io/intro-DS-R_fall-2026/)

```{r}
knitr::include_graphics("images/edst676home.png")
```
:::
::::
...
-   `quarto` or `{bookdown}` --- build your own website
...
This course, and some of the materials prepared and content presented, was originally developed by [Daniel Anderson](https://www.linkedin.com/in/danieljanderson/)
...
Any GenAI use must be disclosed
...
"Share" button in your AI tool for a linke ([Claude](https://support.claude.com/en/articles/10593882-sharing-and-unsharing-chats), [ChatGPT](https://help.openai.com/en/articles/7925741-chatgpt-shared-links-faq), [Gemini](https://support.google.com/gemini/answer/13743730), [Copilot](https://support.microsoft.com/en-us/microsoft-copilot/conversation-history-in-microsoft-copilot))

See the [syllabus](https://jnese.github.io/intro-DS-R_fall-2026/syllabus.html#generative-artificial-intelligence-use) for more detail
